...
export class AnalysisComponent implements OnInit {
  ...
  flamboyant: number[] = [14.84 , 10.02 , 12.84 , 13.02 , 14.84 , 12.02 , 10.84 , 13.02 ,14.84 , 12.02 , 14.84 , 13.87 ];
  neutralising: number[] =[10.76 , 13.18 , 14.76 , 12.18 , 14.76 , 13.18 , 14.76 , 11.18 ,14.76 , 13.18 , 10.76 , 13.45 ]; 
  purist: number[] =[13.7  , 10.06 , 13.7  , 14.06 , 13.7  , 14.06 , 13.7  , 13.06 ,13.7  , 14.06 , 13.7  , 13.44];
  sensible: number[] =  [ 2.752,  2.608,  2.752,  2.608,  2.752,  2.608,  2.752, 2.608,2.752,  2.608,  2.752,  2.77 ];
  aspirant: number[] =[14.32 , 10.99 , 14.32 , 12.99 , 14.32 , 10.99 , 14.32 , 12.99 ,14.32 , 12.99 , 14.32 , 14.26 ];
  hoverer: number[] = [14.27 , 12.81 , 14.27 , 10.81 , 14.27 , 12.81 , 14.27 , 12.81 ,14.27 , 10.81 , 14.27 , 14.09 ]; 
